...
const portCHAR pxManufacturerStringDescriptor[] =
{
	...
	usbDESCRIPTOR_TYPE_STRING,
        ...
        'V', 0x00, 'e', 0x00, 'n', 0x00, 's', 0x00, 'a', 0x00, 'f', 0x00, 'e'
...
const portCHAR pxProductStringDescriptor[] =
{
	...
	'V', 0x00, 'e', 0x00, 'n', 0x00, 's', 0x00, 'a', 0x00, 'f', 0x00, 'e', 0x00, ' ', 0x00, 'U', 0x00, 'S', 0x00, 'B', 0x00
};
...
//const char pxDeviceDescriptor[] =  // pga. endring av serie nr.
char pxDeviceDescriptor[] =
{
	/* Device descriptor */
	0x12,								/* bLength				*/
	...
	0xE3, 0x00,	//						/* idVendorL			*/
	0x24, 0x63,//	0x20, 0x39, // 						/* idProductL			*/
...
const char pxConfigDescriptor[] = {
	...
	*/
	...
	0x20, 0x00, //0x43, 0x00,			/* CwTotalLength 2 EP + Control		?	*/
	0x01,	// !!! 02			/* CbNumInterfaces			  			*/
	0x01,				/* CbConfigurationValue					*/
	usbCONFIGURATION_STRING,/* CiConfiguration					*/
	usbSELF_POWERED,		/* CbmAttributes Bus powered + Remote Wakeup*/
	0x00,				/* CMaxPower: 100mA						*/
